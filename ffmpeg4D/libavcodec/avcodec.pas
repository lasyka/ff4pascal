...
Type
  ...
  *)
  AVCodecID = (AV_CODEC_ID_NONE,
    ...
    AV_CODEC_ID_ADPCM_IMA_APC, AV_CODEC_ID_VIMA = MKBETAG('V', 'I', 'M', 'A'),
...
{$ENDIF}
    ...
    *)
    ...
    $0001, AV_SIDE_DATA_PARAM_CHANGE_CHANNEL_LAYOUT = $0002,
    ...
    *)
    ...
    PAVFrame = ^AVFrame;
    PAVCodecContext=^PAVCodecContext;
...
{$ENDIF}
    ...
    *)
    AVProfile =record
      profile:cint;
      name:pcchar; ///< short name for the profile
    end;
...
AVSubtitleType=(
  ...
  AVSubtitleRect =record
      ...
      *)
       pict:AVPicture;
       avtype:AVSubtitleType;

      text:pcchar;                     ///< 0 terminated plain UTF-8 text
  ...
  AVSubtitle = record
    ...
    *)
    ...
    function  avcodec_alloc_context2(enum AVMediaType):PAVCodecContext;deprecated;
    ...
    *)
    ...
    (* * THIS FUNCTION IS NOT YET PART OF THE PUBLIC API!
      *  we WILL change its arguments and name a few times! *)
    procedure avcodec_get_context_defaults2(s:PAVCodecContext;avtype:AVMediaType);deprecated;
    {$IFEND}
    ...
    *)
    function avcodec_get_context_defaults3( s:PAVCodecContext;codec:Pavcodec):cint;
    ...
    *)
    function avcodec_copy_context(dest:PAVCodecContext;src:PAVCodecContext):cint;
    ...
    *)
    function avcodec_open(AVCodecContext * avctx,avcodec * codec):cint;deprecated;
    {$IFEND}
    ...
    *)
    void avcodec_align_dimensions(AVCodecContext * s, int * width,
    int * height);
    ...
    (* *
      ...
      * according to avcodec_get_edge_width() before.
    *)
    void avcodec_align_dimensions2(AVCodecContext * s, int * width,
    int * height, int linesize_align[AV_NUM_DATA_POINTERS]);
    ...
    *)
    ...
    int16_t * samples, int * frame_size_ptr, AVPacket * avpkt); # endif
    ...
    *)
    int avcodec_decode_audio4(AVCodecContext * avctx, frame: PAVFrame;
    int * got_frame_ptr,
    ...
    *)
    ...
    int avcodec_encode_subtitle(AVCodecContext * avctx, uint8_t * buf,
    int buf_size,
    ...
    *)
    ...
    (* *
      ...
      * @param cutoff cutoff frequency, 1.0 corresponds to half the output sampling rate
    *)
    attribute_deprecated struct AVResampleContext *
    av_resample_init(int out_rate, int in_rate, int filter_length,
    ...
    *)
    attribute_deprecated void av_resample_compensate(struct AVResampleContext *
    c, int sample_delta, int compensation_distance);
    ...
    *)
    ...
    $0004 (* *< loss due to color space conversion *)
  ...
  *)
    ...
    (enum AVPixelFormat * pix_fmt_list, enum AVPixelFormat src_pix_fmt,
...
if AV_HAVE_INCOMPATIBLE_FORK_ABI enum AVPixelFormat avcodec_find_best_pix_fmt2
  (enum AVPixelFormat * pix_fmt_list, enum AVPixelFormat src_pix_fmt,
  int has_alpha, int * loss_ptr);
  #
else
...
int avcodec_default_execute(AVCodecContext * c,
  ...
  *)
  ...
  AVBitStreamFilterContext * av_bitstream_filter_init(

  const char * name); int av_bitstream_filter_filter(AVBitStreamFilterContext *
  bsfc, AVCodecContext * avctx,
...
void av_log_ask_for_sample(void * avc, const char * msg, .. .)
  ...
  *)
  ...
  lockmgr callback may Also be invoked. * )int av_lockmgr_register
  ...
  *)
  const AVCodecDescriptor * avcodec_descriptor_next
  (const AVCodecDescriptor * prev);
