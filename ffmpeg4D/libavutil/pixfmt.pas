...
{$IFEND}
  ...
  // // AV_PIX_FMT_NE(be, le) AV_PIX_FMT_##be
  // // #else
  ...
  // AV_PIX_FMT_0RGB32 = AV_PIX_FMT_NE(0 RGB, BGR0);
  // AV_PIX_FMT_0BGR32 = AV_PIX_FMT_NE(0 BGR, RGB0);
...
Type
  ...
  *)
  AVPixelFormat = (AV_PIX_FMT_NONE = -1, AV_PIX_FMT_YUV420P,
    ...
    AV_PIX_FMT_XVMC_MPEG2_IDCT, AV_PIX_FMT_UYVY422,
