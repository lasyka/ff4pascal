...
{$ifndef FF_API_AVFILTERPAD_PUBLIC }
   FF_API_AVFILTERPAD_PUBLIC  = (LIBAVFILTER_VERSION_MAJOR < 4);
 {$ENDIF}
{$ifndef FF_API_FOO_COUNT }
   FF_API_FOO_COUNT         =           (LIBAVFILTER_VERSION_MAJOR < 4);
 {$ENDIF}
{$ifndef FF_API_FILL_FRAME }
  FF_API_FILL_FRAME           =        (LIBAVFILTER_VERSION_MAJOR < 4);
 {$ENDIF}
{$ifndef FF_API_BUFFERSRC_BUFFER }
   FF_API_BUFFERSRC_BUFFER     =        (LIBAVFILTER_VERSION_MAJOR < 4);
 {$ENDIF}
